var mod = obsidian.module('core.$firebase', ['firebase', 'myApp.config']);

mod.factory('$firebase', ['FBURL', 'config', 'fbutil', '$firebaseObject', '$q', 'snippet', function (FBURL, config, fbutil, $firebaseObject, $q, snippet) {
    var $firebase = {
        FbObj: FbObj,
        update: update,
        set: set,
